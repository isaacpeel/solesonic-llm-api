...
import com.solesonic.izzybot.scope.UserRequestContext;
...
import static com.solesonic.izzybot.tools.jira.CreateJiraTools.JIRA_URL_TEMPLATE;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<IzzyBotResponse> handleChatException(RuntimeException exception) {
    ...
    public ResponseEntity<IzzyBotResponse> handleDuplicateJiraException(DuplicateJiraCreationException duplicateJiraCreationException) {
    ...
    public ResponseEntity<IzzyBotResponse> handleException(Exception exception) {
    ...
    @NotNull
    private ResponseEntity<IzzyBotResponse> buildResponse(String responseMessage) {
        ...
        IzzyBotResponse izzyBotResponse = new IzzyBotResponse(UUID.randomUUID(), chatMessage);
