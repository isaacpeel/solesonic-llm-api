package com.solesonic.izzybot.tools.confluence;

import com.solesonic.izzybot.model.atlassian.confluence.Body;
import com.solesonic.izzybot.model.atlassian.confluence.Page;
import com.solesonic.izzybot.model.atlassian.confluence.Storage;
...
import static com.solesonic.izzybot.service.atlassian.ConfluenceConstants.STORAGE_FORMAT;
...
public class CreateConfluenceTools {
    ...
    @Tool(name = CREATE_CONFLUENCE_PAGE, description = "Creates a confluence page. Use responsibly and ensure no repeated calls for the same request.")
