...
@Service
public class AwsSecretsManagerAtlassianTokenStore implements AtlassianTokenStore {
    
    private static final Logger log = LoggerFactory.getLogger(AwsSecretsManagerAtlassianTokenStore.class);
    ...
    public AwsSecretsManagerAtlassianTokenStore(SecretsManagerClient secretsManagerClient,
